...
$nid = (isset($tab_page) && $tab_page) ? $tab_page : $node->nid;
?>
...
<div class="stp-editor-links highlighted">
  <div class="tabs-wrap-primary-user"><div class="tabsoption-primary-user">
    ...
    <ul class="tabs-primary-live nav"><li class="node-view"><?php print l('<i class="fa fa-eye"></i> View', 'node/' . $nid, array('attributes' => array('class' => array('active')), 'html' => TRUE));?></li>
      <li data-id="node-<?php print $node->nid; ?>" data-tabId= "node-<?php print $nid; ?>" data-type="<?php print $node->type;?>" class="edit-link"><a href="#"><i class="fa fa-edit"></i> Edit</a></li>
      ...
      <a href="/admin/manage/pages/add/pdf/<?php print $nid;?>"><button class="view-versions-btn"><i class="fa fa-icon-pdf"></i> Add PDF Tab</button></a>
       ...
       <?php } if ((isset($tab_page) && $tab_page) && (isset($tab_page_count) && $tab_page_count >= 1)) {?> <a class="editor-tab-title" data-id="node-<?php print $nid; ?>" href="#" data-type="<?php print $node->type;?>"><button class="view-versions-btn"> Edit Tab Title</button></a>
