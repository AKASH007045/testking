...
function onloadRsvpInfoAjax(){  
  ...
  jQuery('body').find('div.closePopup').on('click', function(){
	...
	jQuery(body_group).removeClass('form-tab-info').hide();
...
jQuery( document ).ajaxStart(function() {
  ...
  jQuery(document).on('click',tab_group, function(){
  //alert("sa");	
...
jQuery(document).ready(function(){
  ...
  /**More Info Ajax Click**/
  /* if(jQuery('.event-gallary-thumb-slider .event-list-slider li').length > 0){
	  jQuery('.event-gallary-thumb-slider .event-list-slider li').on("click", function(){
			jQuery(document).ajaxComplete(function(){
