...
(function() {
  var imageDialog = function(editor, dialogType) {
    ...
    function commitInternally(targetFields) {
      ...
      var dialog = this.getDialog();
      var element = dialog.imageElement;
    ...
    var switchLockRatio = function(dialog, value) {
      ...
      if (value == 'check') {
        if (!dialog.userlockRatio && oImageOriginal.getCustomData('isReady') == 'true') {
          ...
          var originalRatio = oImageOriginal.$.width * 1000 / oImageOriginal.$.height;
          var thisRatio = width * 1000 / height;
    ...
    var setupDimension = function(type, element) {
      ...
      var dialog    = this.getDialog();
      var value     = '';
      var dimension = this.id == 'txtWidth' ? 'width' : 'height';
    ...
    var onImgLoadErrorEvent = function() {
      ...
      // Set Error image.
      var noimage = CKEDITOR.getUrl(CKEDITOR.plugins.get('enhanced_image').path + 'images/noimage.png');
              ...
              children: [{
                ...
                children: [{
                  ...
                  validate: function() {
                    ...
                    var isValid = !!(aMatch && parseInt(aMatch[1], 10) !== 0);
            ...
            },
            {
              ...
              children: [{
                ...
                setup: function(type, element) {
                  if (type == IMAGE) {
                    var value;
                    var borderStyle = element.getStyle('border-width');
                ...
                setup: function(type, element) {
                  if (type == IMAGE) {
                    ...
                    var marginLeftStyle  = element.getStyle('margin-left');
                    var marginRightStyle = element.getStyle('margin-right');
                ...
                setup: function(type, element) {
                  if (type == IMAGE) {
                    ...
                    var marginTopStyle    = element.getStyle('margin-top');
                    var marginBottomStyle = element.getStyle('margin-bottom');
              ...
              {
                id: 'cmbAlign',
                requiredContent: 'img{float,display,margin-left,margin-right}',
                type: 'select',
                widths: ['35%', '65%'],
                style: 'width:90px',
                ...
                commit: function(type, element, internalCommit) {
                  ...
                  if (type == IMAGE || type == PREVIEW) {
                      ...
                      if (!internalCommit && type == IMAGE) {
                        ...
                        if (!value) {
                          var ds = element.getStyle('display');
        ...
        },
        {
          ...
          setup: function(type, element) {
            if (type == IMAGE) {
              ...
              var aMatchH = (height ? height : '').match(regexGetSize);
              var aMatchW = (width ? width : '').match(regexGetSize);
  ...
  CKEDITOR.dialog.add('enhanced_image', function(editor) {
