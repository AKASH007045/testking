...
$this->fontdata = array(
  ...
  "rudabold" => array(
		'R' => "Ruda-Black-Bold.ttf"
		),
  "oswaldregular" => array(
		'R' => "oswald.regular-webfont.ttf"
		),
  "oswaldbold" => array(
		'R' => "oswald.bold-webfont.ttf"
		),
  "stainlessregular" => array(
		'R' => "stainlessregular.ttf"
		),
  "titilliumwebbold" => array(
		'R' => "titilliumwebbold.ttf"
		),
  "'titilliumwebblack" => array(
		'R' => "titilliumweb-black-webfont.ttf"
		),
  "titilliumwebregular" => array(
		'R' => "titilliumwebregular.ttf"
		),
  "titilliumwebsemibold" => array(
		'R' => "titilliumwebsemibold.ttf"
		),	
