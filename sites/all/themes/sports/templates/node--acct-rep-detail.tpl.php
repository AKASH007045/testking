...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix slider-wrap-detail"<?php print $attributes; ?>>
  ...
  <h4 class="dedicated-representatives">Dedicated Service Coordinator</h4>
    ...
    <div class="col-md-6 col-fixed"><?php print render($content['field_hometown']); ?>
      ...
      <?php print render($content['field_favorite_moment']); ?></div>
    </div>
   </div>
   <div class="col-md-12 textdtl"><?php print isset($node->body[$language][0]['value']) ? $node->body[$language][0]['value'] : ''; ?></div>
</div>
<?php
